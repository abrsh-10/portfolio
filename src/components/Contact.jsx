...
const Contact = () => {
  ...
  const handleSubmit = (e)=>{
    ...
    emailjs.send('service_wdzoibe','template_oyx7tw3',{
      from_name:form.name,
      to_name:'Abrham',
      from_email:form.email,
      to_email:'abrhamsisay33@gmail.com',
      message:form.message
    },'ZFY2ykvH77cbvLNtD').then(()=>{
      setLoading(false)
      alert("thank you, will get back to you in no time")
    ...
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      <motion.div variants={slideIn('left','tween',0.2,1)} className='flex-[0.75] bg-black-100 p-8 rounded-2xl'>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <button type='submit' className='bg-tertiary py-3 px-8 ouline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl'>
